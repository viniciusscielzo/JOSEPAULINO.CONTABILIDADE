...
<header class="header${medical ? ' campaign-header' : ''}" id="header">
  ...
  <a class="btn btn-small desktop-cta" href="${whatsapp}" target="_blank" rel="noopener">${medical ? 'Comparar PF × PJ' : 'Falar no WhatsApp'} ${arrow}</a>
...
<main>
  <section class="hero hero-diagnostic" id="inicio">
    ...
    <div class="hero-copy reveal">
      <div class="eyebrow light">DESDE 1928 · BRAGANÇA PAULISTA</div>
      <h1>Contabilidade que<br>começa com<br><em>diagnóstico.</em></h1>
      <p>Desde 1928 em Bragança Paulista, cuidando de 250 empresas e produtores. Entregamos leitura do seu negócio, além de guias e obrigações.</p>
      <div class="actions"><a class="btn" href="${whatsapp}" target="_blank" rel="noopener">Falar no WhatsApp ${arrow}</a><a class="btn-link" href="#contato">Agendar diagnóstico <span>↓</span></a></div>
    </div>
    <div class="hero-art heritage-art reveal" aria-hidden="true">
      <div class="heritage-identity">
        <span class="jp-emblem"><img src="/logo-jose-paulino-dark.webp" alt="" width="900" height="301" decoding="async"></span>
        <div class="heritage-year"><span>DESDE</span><strong>1928</strong></div>
      </div>
  ...
  <section class="section services" id="especialidades">
    ...
    <div class="service-grid">
      ${[
        ['01','Contabilidade para Médicos','Carnê-leão, Livro Caixa, simulação PF × PJ, abertura e enquadramento, IRPF.','/contabilidade-para-medicos/'],
        ['02','Contabilidade Rural','LCDPR, Funrural, ITR, atividade rural, arrendamentos, parcerias e planejamento sucessório.','#rural'],
        ['03','Regularização','Escrituração atrasada, débitos, parcelamentos, malha fina e empresa parada sem baixa.','#contato'],
        ['04','Fiscal','Apuração, obrigações, retenções e revisão de enquadramento no Simples Nacional e Lucro Presumido.','#contato'],
        ['05','Societário','Abertura, alterações, reorganização, baixa, licenças e inscrições.','#contato'],
        ['06','Departamento Pessoal','Folha, admissões, demissões, eSocial, FGTS Digital, férias, rescisões e fiscalizações.','#contato']
      ].map(s=>`<a class="service-card reveal" href="${s[3]}"><div class="card-top"><span>${s[0]}</span><div class="card-arrow">↗</div></div><h3>${s[1]}</h3><p>${s[2]}</p><small>Saiba mais</small></a>`).join('')}
    </div>
  </section>
  ...
  <section class="section reasons"><div class="reasons-heading reveal"><div><div class="eyebrow">POR QUE NOS ESCOLHEM</div><h2>Tradição que ainda atende pelo nome.</h2></div><p>Uma estrutura construída para unir permanência, responsabilidade técnica e proximidade no dia a dia.</p></div><div class="reason-rail">
    <article class="reveal"><span>01</span><strong>Desde 1928</strong><p>Três gerações em Bragança Paulista</p></article><article class="reveal"><span>02</span><strong>250 clientes</strong><p>Empresas, produtores rurais e profissionais liberais</p></article><article class="reveal"><span>03</span><strong>1 dia útil</strong><p>Prazo de retorno para qualquer solicitação</p></article>
  </div><div class="reason-principles"><article class="reveal"><span>Equipe própria</span><p>8 profissionais, sem central terceirizada.</p></article><article class="reveal"><span>Sócio no atendimento</span><p>Você fala com quem assina o trabalho.</p></article><article class="reveal"><span>Especialização real</span><p>Rural e Saúde fazem parte da rotina do escritório.</p></article></div></section>
...
<main class="medical-page">
  ...
  <section class="med-proof"><div class="med-proof-number">1928</div><div class="reveal"><div class="eyebrow light">EXPERIÊNCIA ANTES DA CAMPANHA</div><h2>Esta assessoria não começou com este anúncio.</h2><p>O escritório já opera Livro Caixa, carnê-leão e assessoria mensal para profissionais liberais da saúde. É uma rotina real, conduzida por uma equipe própria de 8 profissionais.</p><blockquote>Quem faz plantão nem sempre pode falar com o contador numa terça às 14h. Fora do expediente normal, agendamos.</blockquote><div class="proof-facts"><span><b>Desde 1928</b> em Bragança Paulista</span><span><b>Até 1 dia útil</b> para retornar</span></div></div></section>

  <section class="section process campaign-process"><div class="section-heading reveal"><div class="eyebrow">COMO FUNCIONA</div><h2>Uma conversa. Dois cenários. Uma decisão mais <em>clara.</em></h2></div><div class="process-grid"><article><span>01</span><h3>Entendimento</h3><p>Mapeamos fontes de receita, despesas e forma de atuação.</p></article><article><span>02</span><h3>Simulação</h3><p>Comparamos PF e PJ com os seus números reais.</p></article><article><span>03</span><h3>Próximo passo</h3><p>Mostramos a estrutura indicada e, se fizer sentido, organizamos a rotina mensal.</p></article></div><a class="btn campaign-process-cta" href="${whatsapp}" target="_blank" rel="noopener">Quero analisar meus números ${arrow}</a></section>
...
export function initSite() {
  ...
  const whatsappMessage = isMedical
    ? `Olá! ${fromSocial ? 'Vim pelo Instagram e ' : ''}gostaria de comparar meu cenário como médico entre pessoa física e pessoa jurídica.`
